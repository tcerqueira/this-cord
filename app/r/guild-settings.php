           ...
           <section class="guild-section" id="costumize-server">
                    ...
                    <div class = "guild-sections-container" >
                        <div class="settings-item">
                            ...
                            <button class="button" type="button" id ="editGuildNameButton"> Edit</button>
                        </div>
                        ...
                        <div class="settings-item">
                            ...
                            <button class="button" type="button" id= "editGuildInitialsButton"> Edit </button>
                        </div>
                        ...
                        <hr>
                        <button class= "button" id="guild-save-changes"> Save Changes</button>
                    </div>
                ...
                <div class = "guild-sections-container" >
                    <div class="settings-item">
                        <div>
                            ...
                            <div id= "" class="text-input-container text-input-container-color"><input class="user-text-input" type="text" id=""></div>
                            <!-- <span id="myaccount-username"></span> -->
                        </div>
                        <div>
                            <button class="button" type="button" id ="editGuildNameButton"> Edit</button>
                    ...
                    <hr>
                    <button class="button" type="button" id ="create-text-channel-button"> Create new text-channel </button>
                    <div id="create-text-channel-div">
                        Channel Name:
                        <div class="text-input-container"><input type="text" id="add-text-channel-name"></div>
                        <button class="button" type="button" id ="confirm-add-text-channel"> Add</button>
                    </div>
                </div>
                channels, butão create, editar, delete
           </section>
                ...
                <div class="guild-sections-container">
                   <div class="member-role" >
                        ...
                        <div>
                            ...
                            <button class="button" type="button" id ="confirm-add-text-channel"> Kick </button>
                        </div>
                   </div>
               </div>
