...
<body>
    ...
    <div id="currentGuildname" data-guildname="<?php echo $_GET['guildname']; ?>" style="display:none;"></div>
    <div id="currentGuildAvatar" data-guild-avatar="<?php echo $_GET['avatar']; ?>" style="display:none;"></div>
    <main>
        <div class="display-prompt rounded-container">
            <div>
                <div class="icon-card icon-size-xbig">
                    <img src="" alt="guild avatar">
                </div>
                <span id="guildname">Guildname</span>
            </div>
            <button id="joinBtn" class="button bg-green">Join</button>
